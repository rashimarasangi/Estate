...
const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "27cdb2c5-dd50-4bb6-92a8-40a0d6f54da6");
  ...
  return (
    ...
    >
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Ready To Make a Movie? Let's build Your Future Together</p>
